 ...
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC,  KC_RBRC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_ESC,
                  KC_LALT, KC_LGUI,LT(1,KC_LANG2), KC_SPC,   KC_ENT,LT(2,KC_LANG1),KC_BSPC, KC_RGUI
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
...
[_RAISE] = LAYOUT(
  ...
  KC_LSFT,  KC_DEL, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  _______, _______,  KC_PIPE, KC_PLUS, KC_BSLS, KC_LBRC, KC_RBRC, KC_TILD,
                             _______, _______, _______,  _______, _______,  _______, _______, _______
),
/* ADJUST
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
